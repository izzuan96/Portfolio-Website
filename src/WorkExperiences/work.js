...
const workExperiences = [
  {
    ...
    customClass: 'accenture-class', // Unique class for Accenture
  },
  {
    id: 2,
    company: 'Maybank',
    ...
    customClass: 'maybank-class', // Unique class for Maybank
  },
  {
    id: 3,
    ...
    customClass: 'apm-class', // Unique class for APM
  },
  {
    id: 4,
    ...
    customClass: 'schlumberger-class', // Unique class for Schlumberger
  },
];
        ...
        <div className='workList'>
          {workExperiences.map(experience => (
            <div key={experience.id} className='workItem'>
              <div className={`imgcontainer ${experience.customClass}`}>
